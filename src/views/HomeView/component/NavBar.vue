...
<template>
  <nav class="nav-bar fixed bg-hero-bg py-3 lg:py-4 z-50 w-full">
    <div class="container flex justify-between items-center">
      <!-- Brand Logo -->
      <div class="brand-logo w-16 lg:w-20 2xl:w-28">
        <RouterLink to="/">
      ...
      <div class="block md:hidden">
        <span
            class="icon-hamburger text-accent text-xl"
            @click="$emit('toggleMenuSidebar', true)"
        />
      </div>
      <div class="hidden md:flex items-center md:gap-10 xl:gap-20 3xl:gap-28">
        <ul class="nav-links md:space-x-14 xl:space-x-24 3xl:space-x-38 md:flex lg:text-xl xl:text-2xl 3xl:text-3xl text-accent">
